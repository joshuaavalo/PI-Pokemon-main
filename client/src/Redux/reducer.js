...
const rootReducer = (state = initialState, {type,payload}) => {
  switch(type) {
      ...
      case FILTER_POKEMONS_BY_SOURCE:
            ...
            const dbPokemons = state.allPokemons.filter((pokemon) => (pokemon.created === true ));
            const apiPokemons = state.allPokemons.filter((pokemon) => (pokemon.created === false ));
